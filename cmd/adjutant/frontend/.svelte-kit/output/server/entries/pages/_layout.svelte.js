import { c as create_ssr_component, e as escape, a as add_attribute, b as compute_slots, s as setContext, d as compute_rest_props, g as getContext, f as spread, h as escape_attribute_value, i as escape_object, j as subscribe, v as validate_component } from "../../chunks/ssr.js";
  ...
  return `${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    pageHeader: () => {
      return `${validate_component(AppBar, "AppBar").$$render(
        ...
        {
          trail: () => {
            return `<button type="button" class="btn btn-sm variant-ghost-secondary" data-svelte-h="svelte-1p7t6qv"><span class="icon-[mdi--refresh]"></span> <span>Read</span></button> `;
          },
          default: () => {
            return `<h2 data-svelte-h="svelte-1bnt9cz">Adjutant</h2>`;
          }
        }
      )} `;
    },
      ...
      return `${validate_component(AppRail, "AppRail").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(AppRailAnchor, "AppRailAnchor").$$render(
            ...
            {
              default: () => {
                return `<span class="icon-[mdi--home]" style="font-size: 24px;"></span><br> <span data-svelte-h="svelte-xzvu3f">Main</span>`;
              }
            }
            ...
            {
              default: () => {
                return `<span class="icon-[mdi--cogs]" style="font-size: 24px;"></span><br> <span data-svelte-h="svelte-1vto2yn">Settings</span>`;
              }
            }
          )}`;
        }
